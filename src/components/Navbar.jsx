...
const Navbar = () => {
  ...
  return (
    <div>
      <nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-600">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a>
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-yellow-300">
              Resort
            </span>
          </a>
          <div class="flex md:order-2">
            <button
              type="button"
              class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-00 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark::hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              {" "}
              get started
            </button>
